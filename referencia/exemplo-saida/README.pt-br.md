...
A subpasta [`en/`](en/) tem os mesmos 5 PDFs renderizados em inglês (mudando apenas `respostas.json::metadata.language` para `"en"`). A subpasta [`es/`](es/) tem a versão em espanhol (`"es"`).
