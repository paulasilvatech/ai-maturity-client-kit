...
**Output em `saida/`:**
- `insights-developer-survey-DATE.md` — relatório (inglês por padrão, PT-BR/ES via `metadata.language`) de ~14 páginas equivalentes
...
1. Leia **[`survey-learning/INSTRUCOES-FORMS-LEARNING.md`](survey-learning/INSTRUCOES-FORMS-LEARNING.pt-br.md)**
