...
Os PDFs saem em inglês por padrão. Edite `respostas.json::metadata.language` para `"pt-BR"`, `"es"` ou `"en"` e rode `/gerar-relatorio`.
...
- Algoritmo de scoring → [`../referencia/pontuacao-e-calculo.md`](../referencia/pontuacao-e-calculo.pt-br.md)
