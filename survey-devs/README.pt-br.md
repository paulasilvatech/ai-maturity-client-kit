...
> 💡 **Survey complementar a este:** depois de rodar o **survey-devs** (anônimo, mede comportamento), considere também o **[survey-learning](../survey-learning/README.pt-br.md)** (identificado, mede o que devs querem aprender). Os 2 juntos formam um diagnóstico 360° dos devs — comportamental + aspiracional.
...
| **Skills** | `/calcular-scores`, `/gerar-relatorio` etc. | `/importar-survey-devs` + `/insights-developer-survey` | [`/importar-survey-learning`](../survey-learning/README.pt-br.md) + `/plano-capacitacao` |

**Os 3 são complementares:**
- Este **survey-devs** mede COMPORTAMENTO (anônimo)
- O **[survey-learning](../survey-learning/README.pt-br.md)** mede DESEJO (identificado, complementa este)
